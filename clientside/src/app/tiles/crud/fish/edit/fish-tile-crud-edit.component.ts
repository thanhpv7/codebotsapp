...
@Component({
	selector: 'cb-fish-tile-crud-edit',
	templateUrl: './fish-tile-crud-edit.component.html',
	styleUrls: [
		'./fish-tile-crud-edit.component.scss',
...
export class FishTileCrudEditComponent implements OnInit, OnChanges, OnDestroy
...
// % protected region % [Add any additional interfaces to implement here] end
{
	 ...
	 */
	@Input()
	collectionId: string = 'a623e09f-5ccc-45fe-a1c7-e860b58f5c3e-create-edit';
	...
	private fetchEntity() {
		...
		this.store.select(getFishModelWithId, this.targetModelId).subscribe(model => {
