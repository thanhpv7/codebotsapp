...
import {FishTileCrudListComponent} from './list/fish-tile-crud-list.component';
import {FishTileCrudEditComponent} from './edit/fish-tile-crud-edit.component';
import {FishTileCrudComponent} from './fish-tile-crud.component';
import {FishTileCrudRoutingModule} from './fish-tile-crud-routing.module';
...
@NgModule({
	declarations: [
		FishTileCrudListComponent,
		FishTileCrudEditComponent,
