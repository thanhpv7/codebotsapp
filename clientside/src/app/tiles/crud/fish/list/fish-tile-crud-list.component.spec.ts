...
import {FishTileCrudListComponent} from './fish-tile-crud-list.component';
 ...
 */
describe('Fish Crud List Tile Component', () => {

	let fixture;
	let fishTileCrudListComponent: FishTileCrudListComponent;
	...
	beforeEach(async(() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(FishTileCrudListComponent);
			fishTileCrudListComponent = fixture.debugElement.componentInstance;
	...
	it ('Reset the page index and update page count after searching', () => {
		...
		expect(fishTileCrudListComponent.fishsCount).toBe(defaultData.length);
		...
		expect(fishTileCrudListComponent.pageIndex).toBe(1);
		fixture.detectChanges();

		// Trigger the search function
		spyOn(fishTileCrudListComponent, 'onCollectionSearch').and.callThrough();
		...
		fishTileCrudListComponent.onCollectionSearch(searchContent);
		fixture.detectChanges();
		...
		expect(fishTileCrudListComponent.fishsCount).toBe(filteredDataSize);
		expect(fishTileCrudListComponent.pageIndex).toBe(0);
