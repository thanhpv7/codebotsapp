...
@Component({
	selector: 'cb-species-tile-crud-edit',
	templateUrl: './species-tile-crud-edit.component.html',
	styleUrls: [
		'./species-tile-crud-edit.component.scss',
...
export class SpeciesTileCrudEditComponent implements OnInit, OnChanges, OnDestroy
...
// % protected region % [Add any additional interfaces to implement here] end
{
	 ...
	 */
	@Input()
	collectionId: string = 'a0307051-8647-4efd-9b4c-9793ba9df67b-create-edit';
	...
	private fetchEntity() {
		...
		this.store.select(getSpeciesModelWithId, this.targetModelId).subscribe(model => {
