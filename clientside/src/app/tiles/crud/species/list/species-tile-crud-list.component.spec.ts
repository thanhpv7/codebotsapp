...
import {SpeciesTileCrudListComponent} from './species-tile-crud-list.component';
 ...
 */
describe('Species Crud List Tile Component', () => {

	let fixture;
	let speciesTileCrudListComponent: SpeciesTileCrudListComponent;
	...
	let collectionId = 'a0307051-8647-4efd-9b4c-9793ba9df67b';
	...
	beforeEach(async(() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(SpeciesTileCrudListComponent);
			speciesTileCrudListComponent = fixture.debugElement.componentInstance;
	...
	it ('Reset the page index and update page count after searching', () => {
		...
		expect(speciesTileCrudListComponent.speciessCount).toBe(defaultData.length);
		...
		expect(speciesTileCrudListComponent.pageIndex).toBe(1);
		fixture.detectChanges();

		// Trigger the search function
		spyOn(speciesTileCrudListComponent, 'onCollectionSearch').and.callThrough();
		...
		speciesTileCrudListComponent.onCollectionSearch(searchContent);
		fixture.detectChanges();
		...
		expect(speciesTileCrudListComponent.speciessCount).toBe(filteredDataSize);
		expect(speciesTileCrudListComponent.pageIndex).toBe(0);
