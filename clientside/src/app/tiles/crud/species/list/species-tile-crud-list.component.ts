...
import {SpeciesModelState} from '../../../../models/species/species.model.state';
...
@Component({
	selector: 'cb-species-tile-crud-list',
	templateUrl: './species-tile-crud-list.component.html',
	styleUrls: [
		'./species-tile-crud-list.component.scss',
...
export class SpeciesTileCrudListComponent implements OnInit {
	/**
	 ...
	 */
	@Input()
	collectionId: string = 'a0307051-8647-4efd-9b4c-9793ba9df67b';
