...
import {TankTileCrudListComponent} from './list/tank-tile-crud-list.component';
import {TankTileCrudEditComponent} from './edit/tank-tile-crud-edit.component';
import {TankTileCrudComponent} from './tank-tile-crud.component';
import {TankTileCrudRoutingModule} from './tank-tile-crud-routing.module';
...
@NgModule({
	declarations: [
		TankTileCrudListComponent,
		TankTileCrudEditComponent,
