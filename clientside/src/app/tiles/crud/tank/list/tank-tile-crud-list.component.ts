...
import {TankModelState} from '../../../../models/tank/tank.model.state';
...
@Component({
	selector: 'cb-tank-tile-crud-list',
	templateUrl: './tank-tile-crud-list.component.html',
	styleUrls: [
		'./tank-tile-crud-list.component.scss',
...
export class TankTileCrudListComponent implements OnInit {
	/**
	 ...
	 */
	@Input()
	collectionId: string = '7296cf06-3058-47f9-bc40-9604f64d09fa';
