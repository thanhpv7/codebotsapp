...
import {TankTileCrudListComponent} from './tank-tile-crud-list.component';
 ...
 */
describe('Tank Crud List Tile Component', () => {

	let fixture;
	let tankTileCrudListComponent: TankTileCrudListComponent;
	...
	let collectionId = '7296cf06-3058-47f9-bc40-9604f64d09fa';
	...
	beforeEach(async(() => {
		...
		TestBed.configureTestingModule({
			...
			fixture = TestBed.createComponent(TankTileCrudListComponent);
			tankTileCrudListComponent = fixture.debugElement.componentInstance;
	...
	it ('Reset the page index and update page count after searching', () => {
		...
		expect(tankTileCrudListComponent.tanksCount).toBe(defaultData.length);
		...
		expect(tankTileCrudListComponent.pageIndex).toBe(1);
		fixture.detectChanges();

		// Trigger the search function
		spyOn(tankTileCrudListComponent, 'onCollectionSearch').and.callThrough();
		...
		tankTileCrudListComponent.onCollectionSearch(searchContent);
		fixture.detectChanges();
		...
		expect(tankTileCrudListComponent.tanksCount).toBe(filteredDataSize);
		expect(tankTileCrudListComponent.pageIndex).toBe(0);
