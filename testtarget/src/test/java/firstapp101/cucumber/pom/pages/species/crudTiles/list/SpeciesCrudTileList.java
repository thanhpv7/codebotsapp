 ...
 */
package firstapp101.cucumber.pom.pages.species.crudTiles.list;
...
@Slf4j
@ScenarioScoped
public class SpeciesCrudTileList extends CrudTileList {

	private final String tagName = "cb-species-tile-crud-list";
