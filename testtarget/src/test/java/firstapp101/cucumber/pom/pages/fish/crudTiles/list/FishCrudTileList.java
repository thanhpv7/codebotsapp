 ...
 */
package firstapp101.cucumber.pom.pages.fish.crudTiles.list;
...
@Slf4j
@ScenarioScoped
public class FishCrudTileList extends CrudTileList {

	private final String tagName = "cb-fish-tile-crud-list";
