 ...
 */
package firstapp101.cucumber.pom.pages.tank.crudTiles.edit;
...
@Slf4j
@ScenarioScoped
public class TankCrudTileEdit extends CrudTileEdit {

	private final String tagName = "cb-tank-tile-crud-edit";
	...
	@FindBy(how = How.XPATH, using = "//" + tagName + "//input[@id='width-field']")
	private WebElement widthField;
	// TODO default handling dataAttribute lengthField;
	@FindBy(how = How.XPATH, using = "//" + tagName + "//input[@id='length-field']")
	private WebElement lengthField;
	// TODO default handling dataAttribute heightField;
	@FindBy(how = How.XPATH, using = "//" + tagName + "//input[@id='height-field']")
	private WebElement heightField;
	// TODO default handling dataAttribute lastCleanedField;
	@FindBy(how = How.XPATH, using = "//" + tagName + "//input[@id='lastCleaned-field']")
	private WebElement lastCleanedField;
	@FindBy(how = How.XPATH, using = "//" + tagName + "//ng-select[@id='clean-field']")
	...
	@FindBy(how = How.XPATH, using = "//" + tagName + "//ng-select[@id='fishTankIds-field']")
