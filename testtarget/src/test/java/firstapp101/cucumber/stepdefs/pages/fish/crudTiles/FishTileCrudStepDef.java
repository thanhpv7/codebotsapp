 ...
 */
package firstapp101.cucumber.stepdefs.pages.fish.crudTiles;

import firstapp101.cucumber.pom.pages.fish.crudTiles.edit.FishCrudTileEdit;
import firstapp101.cucumber.pom.pages.fish.crudTiles.list.FishCrudTileList;
...
@Slf4j
@ScenarioScoped
public class FishTileCrudStepDef extends AbstractStepDef {

	@Inject
	FishCrudTileEdit fishCrudTileEdit;

	@Inject
	FishCrudTileList fishCrudTileList;
	 ...
	 */
	private AbstractEntity fishEntity;
	...
	@When("I create references for crud tile Fish in page Fish")
	public void Fish() throws Exception {
		fishEntity = getEntityFactory("Fish").createWithNoRef();
		for (EntityReference reference : fishEntity.References) {
	...
	@When("I click on create button in crud tile Fish in page Fish")
	public void clickCreateButton() throws Exception {
		fishCrudTileList.createButton.click();
	}

	@Then("I create a valid entity in crud tile Fish in page Fish")
	public void createValidEntityInTile() throws Exception {
		fishCrudTileEdit.applyEntity(fishEntity);
	}

	@Then("I verify Fish list in page Fish")
	public void verifyCrudTileList() throws Exception {
		webDriverWait.until(x -> fishCrudTileList.CrudListItems.size() > 0);
	}

	@When("I update an existing entity in crud tile Fish of page Fish")
	public void updateEntityInFrontend() throws Exception {
		...
		webDriverWait.until(x -> fishCrudTileList.CrudListItems.size() > 0);
		fishCrudTileList.EditButtons.get(0).click();
		fishEntity = getEntityFactory("Fish").createWithNoRef();
		fishCrudTileEdit.applyEntity(fishEntity);
	...
	@When("I view an existing entity in crud tile Fish of page Fish")
	public void viewEntityInFrontend() throws Exception {
		...
		// wait for the list to be populated with values
		webDriverWait.until(x -> fishCrudTileList.CrudListItems.size() > 0);
		fishCrudTileList.ViewButtons.get(0).click();
	...
	@When("I delete an existing entity in crud tile Fish of page Fish")
	public void deleteEntityInFrontend() throws Exception {
		...
		fishCrudTileList.DeleteButtons.get(0).click();
